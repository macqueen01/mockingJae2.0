<script>
    ...
    <div
        ...
        out:slide={{ duration: 600, easing: quintIn }}
    >
        <div class="meme-house-nav-bar">
            ...
            <div class="meme-house-icon-container">
                <svg
                    ...
                    width="30px"
                    height="30px"
                    viewBox="0 0 1584.000000 1584.000000"
                    preserveAspectRatio="xMidYMid meet"
                >
                    <g
                        transform="translate(0.000000,1584.000000) scale(0.100000,-0.100000)"
                        fill="#59545f"
                        stroke="none"
                    >
                        <path
                            d="M7172 14295 c-72 -23 -165 -101 -482 -401 -36 -34 -83 -78 -105 -99
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            ...
                                            d="M8128 15401 c-90 -30 -160 -103 -173 -181 -19 -110 55 -220 167 -248
...
-2712 1772 -4382 1921 -199 18 -791 29 -832 16z"
                                        ...
                                        <path
                                            ...
                                            d="M12795 11610 c-116 -25 -259 -95 -387 -192 -270 -204 -1025 -895
