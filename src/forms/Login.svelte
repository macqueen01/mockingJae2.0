<script>
	...
	function labelHandle(index) {
        console.log("clicked")
		if (index) {
			document.querySelector('.password-input').focus = true;
		} else {
			document.querySelector('.email-input').focus = true;
		}
	}
